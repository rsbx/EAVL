...
int check_tree(
	...
	if ((error = EAVLp_Context_Init(&checkcontext, NULL)))
		{
		printf("ERROR: Context_Init: %d\n", error);
		printf("\t%s:%u\n", __FILE__, __LINE__);
		exit(1);
		}
	if ((error = EAVLp_Context_Associate(&checkcontext, context->tree)))
		{
...
out:
	if ((error = EAVLp_Context_Disassociate(&checkcontext)))
		{
...
//	if ((error = EAVLp_Tree_Init(tree, NULL, &cbset)))
//		{
...
//		}
//
//	if ((error = EAVLp_Context_Init(context, NULL, NULL)))
//		{
//		printf("ERROR: Context_Init: %d\n", error);
//		printf("\t%s:%u\n", __FILE__, __LINE__);
//		exit(1);
//		}
//
//	if ((error = EAVLp_Context_Associate(context, tree)))
//		{
//		printf("ERROR: Context_Associate: %d\n", error);
//		printf("\t%s:%u\n", __FILE__, __LINE__);
//		exit(1);
//		}
	...
	if ((error = EAVLp_Clear(context, &Node_release)))
		{
...
void build_tree(
	...
	if ((error = EAVLp_Load(context, count, nodep)))
		{
...
*/
	...
	if ((error = EAVLp_Context_Init(&context, NULL)))
		{
		printf("ERROR: Context_Init: %d\n", error);
		printf("\t%s:%u\n", __FILE__, __LINE__);
		exit(1);
